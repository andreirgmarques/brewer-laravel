...
Brewer.EstiloCadastroRapido = (function () {
    ...
    function EstiloCadastroRapido() {
        ...
        this.inputTokenCsrf  = $('input[name=_token]');
    ...
    function onBotaoSalvarClick() {
        ...
        var tokenCsrf  = this.inputTokenCsrf.val();
        $.ajax({
            url: this.url,
            method: 'POST',
            contentType: 'application/json',
            data: JSON.stringify({_token: tokenCsrf, nome: nomeEstilo}),
    ...
    function onErroSalvandoEstilo(obj) {
        var mensagemErro = obj.responseJSON.nome;
