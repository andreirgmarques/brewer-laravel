...
return [
    ...
    */
    ...
    'after_or_equal'       => ':attribute deve ser uma data igual ou depois de :date.',
    ...
    'min'                  => [
        ...
        'file'    => 'O campo :attribute deve ter no mínimo :min kilobyte(s).',
        'string'  => 'O campo :attribute deve ter no mínimo :min caracter(es).',
